 ...
 */
class AddGridItemCounts extends ModelExtension implements FiltersSequencer {
	const AllItemCountKey = 'AllItemCount';

	public function sequenceGridListFilters(&$filters, $groups, &$parameters = []) {
